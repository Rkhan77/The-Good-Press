-- A topic becomes a preferred category only after ten positive signals.
-- Explicit choices in the app are stored with a score of 10, so they remain preferred.
